...
<div class="content">
    <div class="container">
        <div class="row">
            ...
            <div class="col s12">
                <div class="title">
                   <h3 class="title-vm"><i class="fas fa-user"></i> <?php echo Yii::t('app', 'Profile');?> <p><?php echo Yii::t('app', 'You can change your profile informations');?></p></h3>
                </div>
                ...
                <div class="title">
                    <h3 class="title-vm"><i class="fas fa-lock"></i> <?php echo Yii::t('app', 'Password');?> <p><?php echo Yii::t('app', 'You can change your account password');?></p></h3>
                </div>
                ...
                <div class="title">
                    <h3 class="title-vm"><i class="fas fa-envelope"></i> <?php echo Yii::t('app', 'Email');?> <p><?php echo Yii::t('app', 'You can change your account email');?></p></h3>
                </div>
