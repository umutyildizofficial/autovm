...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col s12">
                <div class="title">
                    <h3>Email Oluştur <p>Lütfen email adresi oluşturunuz</p></h3>
                </div>
                ...
                <?php $form = ActiveForm::begin(['fieldConfig' => ['template' => $template]]);?>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn waves-light waves-effect amber">Oluştur</button>
                    </div>
                <?php ActiveForm::end();?>
            </div>
        </div>
