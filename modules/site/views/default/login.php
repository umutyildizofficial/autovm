...
<div class="content">
    <div class="container">
                <div class="title">
                     <h3 class="title-vm"><i class="fas fa-user"></i> <?php echo Yii::t('app', 'Login Form');?> <p><?php echo Yii::t('app', 'Please login to your account');?></p></h3>
                </div>
                ...
                <?php $form = ActiveForm::begin(['fieldConfig' => ['template' => $template]]);?>
                    ...
                    <div class="form-group">
                        <label class="checkbox" style="left:20px; position:relative;"><input type="checkbox" name="LoginForm[rememberMe]" value="1"> <span></span> <?php echo Yii::t('app', 'Remember me next time');?></label>
                    </div>
                    <div class="form-group">
