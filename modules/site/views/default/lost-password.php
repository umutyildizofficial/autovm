...
Yii::$app->setting->title .= ' - şifremi unuttum';
...
<div class="content">
    <div class="container">
        <div class="row">
                <div class="title">
                    <h3 class="title-vm"><i class="fas fa-lock"></i><?php echo Yii::t('app', 'Lost Password');?><p><?php echo Yii::t('app', 'Forgot your password? Do not worry about that');?></p></h3>
                </div>
