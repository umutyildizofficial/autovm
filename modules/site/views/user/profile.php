...
Yii::$app->setting->title .= ' - profil bilgileri';
...
<div class="content">
    <div class="container">
        <div class="row">
            <div class="col s12">
                <div class="title">
                    <h3 class="title-vm"><div class="container"><i class="fas fa-user"></i>  <p>Profil bilgilerinizi değiştirebilirsiniz</p></h3>
                </div>
                <?php echo \app\widgets\Alert::widget();?>
                <?php $form = ActiveForm::begin(['fieldConfig' => ['template' => $template]]);?>
                <?php echo $form->field($model, 'first_name')->textInput(['placeholder' => 'İsim']);?>
                <?php echo $form->field($model, 'last_name')->textInput(['placeholder' => 'Soyisim']);?>
