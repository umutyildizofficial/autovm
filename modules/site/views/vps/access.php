...
<div id="ilerlemesureci" style="display:none;"></div>
...
<div id="sunucu-genel-islemler-<?php echo $vps->id;?>" class="tab-pane fade in active">
                    ...
                    <div class="col-lg-4 col-sm-4">
						...
						<div class="detail-vm"><?php
							...
							<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6"><a href="javascript:void(0);" class="vm-button" onclick="loadItem(<?=$vps->id;?>, 7)"><span class="vm-icon"><i class="fas fa-hdd"></i></span> <?php echo Yii::t('app', 'Extend hard');?></a></div>
