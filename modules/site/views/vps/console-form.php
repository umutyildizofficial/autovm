...
$("form").submit(function(e) {
	...
	$.post(self.attr("action"), self.serialize(), "JSON").done(function(data) {
        ...
        content = "<a target='_blank' href='" + data.address + ":$port/vnc_lite.html?password=$pw'>Konsolu açmak için buraya tıklayınız</a>";
        new simpleAlert({title:"Konsol", content:content});
	});
});
