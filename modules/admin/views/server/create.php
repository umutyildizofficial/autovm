...
<!-- content -->
  ...
  <div class="page-content__header">
    <div>
      <h2 class="page-content__header-heading">Fiziksel Sunucu Oluştur </h2>
    </div>
  </div>
...
<div class="main-container">
	    ...
	    <?php echo $form->field($model, 'virtualization')->dropDownList(\app\models\Server::getVirtualizationList());?>
            ...
            <?php echo $form->field($model, 'dns1')->textInput(['value' => '8.8.8.8']);?>
            <?php echo $form->field($model, 'dns2')->textInput(['value' => '8.8.4.4']);?>
