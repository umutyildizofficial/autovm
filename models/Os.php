...
class Os extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'name' => Yii::t('app', 'İşletim Sistemi'),
            'type' => Yii::t('app', 'Tipi'),
			'username' => Yii::t('app', 'Kullanıcı Adı'),
			'password' => Yii::t('app', 'Şifre'),
            'adapter' => Yii::t('app', 'Ağ Adaptörü'),
            'guest' => Yii::t('app', 'Guest İşletim Sistemi'),
            'created_at' => Yii::t('app', 'Oluşturulma'),
            'updated_at' => Yii::t('app', 'Güncellenme'),
            'status' => Yii::t('app', 'Durum'),
            'operation_system' => Yii::t('app', 'İşletim Sistemi'),
    ...
    public static function getGuests()
    {
        return [
			...
			'windows8_64Guest' => 'Windows 10 64 bit',
            'other' => 'Other',
        ];
    }
    ...
    public static function getStatusList()
    {
        return [
            ...
            self::STATUS_INACTIVE => Yii::t('app', 'Pasif'),
        ];
    }
