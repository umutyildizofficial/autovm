...
class Vps extends \yii\db\ActiveRecord
{
    ...
    public function getIp()
    {
        ...
        return $this->hasOne(Ip::className(), ['id' => 'ip_id'])->viaTable('vps_ip', ['vps_id' => 'id'], function ($query) {
            $query->andWhere(['id' => $this->vpsip->id])
    ...
    {
        return $this->hasOne(VpsIp::className(), ['vps_id' => 'id']);
    }
