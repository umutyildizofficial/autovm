...
class Ip extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'mac_address' => Yii::t('app', 'Mac Adresi'),
    ...
    {
        return [
            self::IS_MAIN => Yii::t('app', 'Birincil Network'),
            self::IS_SECOND => Yii::t('app', 'İkincil Network'),
            self::IS_THIRD => Yii::t('app', 'Plan Networku Aktif'),
        ];
    }
    ...
    {
        return [
            self::IS_NOT_DHCP => Yii::t('app', 'Hayır'),
            self::IS_DHCP => Yii::t('app', 'Evet'),
        ];
    }
}
