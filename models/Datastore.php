...
class Datastore extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'uuid' => Yii::t('app', 'Uuid'),
            'value' => Yii::t('app', 'Disk Adı'),
            'space' => Yii::t('app', 'Disk Alanı'),
            'is_default' => Yii::t('app', 'Varsayılan mı?'),
            'vsan' => Yii::t('app', 'Vsan'),
    ...
    {
        return [
            self::IS_DEFAULT => Yii::t('app', 'Evet'),
            self::IS_NOT_DEFAULT => Yii::t('app', 'Hayır'),
        ];
    }
    ...
    {
        return [
            self::VSAN_NO => Yii::t('app', 'Hayır'),
            self::VSAN_YES => Yii::t('app', 'Evet'),
        ];
    }
